...
public class ArrayMap<K, V> implements Map61B<K, V>, Iterable<K> {
    ...
    /** protected means it can be use in subclass and same package. */
    protected int size;

    /** Without any sign, this variable is package-private
     */
    int rubbish;
    /** Packages are typically modified by a specific 
     * team of people, so it's more secret than sub-class.
     */
    ...
    public Iterator<K> iterator() {
        /** Use this to make the KeyIterator "visible". */
